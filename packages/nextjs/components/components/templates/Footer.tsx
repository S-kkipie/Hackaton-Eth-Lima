...
import { CenteredFooter } from "@/components/features/landing/CenteredFooter";
    ...
    <Section className="pb-16 pt-0">
      <CenteredFooter
        ...
        legalLinks={
          <>
            <li>
              <Link href="/sign-up">Términos del servicio</Link>
            </li>
            <li>
              <Link href="/sign-up">Política de privacidad</Link>
            </li>
          </>
        }
      >
        <li>
          <Link href="/sign-up">Producto</Link>
        </li>
        ...
        <li>
          <Link href="/sign-up">Comunidad</Link>
        </li>

        <li>
          <Link href="/sign-up">Empresa</Link>
        </li>
      </CenteredFooter>
    </Section>
  );
